...
\begin{frame}{\secname}
	\framesubtitle{Identity relation~[5] --- MR~1}
...
\begin{frame}{\secname}
	\framesubtitle{Points shuffle relation~[9] --- MR~2}
	\begin{figure}
        	\centering
        	\begin{tikzpicture}
			\tiny
...
\begin{frame}{\secname}
	\framesubtitle{Attributes shuffle~[4,5] --- MR~3}
	\begin{figure}
		\centering
		\begin{tikzpicture}
			\tiny
...
\begin{frame}{\secname}
	\framesubtitle{Transformation relation~[4,5] --- MR~4}
	\begin{figure}
		\centering
		\begin{tikzpicture}
			\tiny
...
\begin{frame}{\secname}
	\framesubtitle{Class permutation relation~[4,5] --- MR~5}
	\begin{figure}
		\centering
		\begin{tikzpicture}
			\tiny
